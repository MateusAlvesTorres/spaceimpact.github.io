    ...
    // --------------------Definindo as sprites do jogo---------------------------

    backgroundImage.src = "Sprites/space_image_void.png";
    ...
    enemy.img1.src = "Sprites/enemy1.png";
    enemy.img2.src = "Sprites/enemy2.png";
    boss.img1.src = "Sprites/boss_image1.png";
    boss.img2.src = "Sprites/boss_image2.png";

    // --------------------Criando as variáveis de armazenamento---------------------------
    ...
    // --------------------Definindo os comandos da nave através do mouse---------------------------
    ...
    // --------------------Definindo plano de fundo do jogo---------------------------
    ...
    // ---------------Iniciando o game através do click do mouse no botão de start----------------------
    ...
    // -------------Criando função para iniciar o game e montando sua estrutura--------------------
    ...
    // --------------------Criando função de jogar novamente---------------------------
    ...
    // --------------Desenhando a nave do jogo e suas interações-----------------
    ...
    // --------------Desenhando inimigos do jogo e suas interações-----------------
        ...
        for (var i in enemies) {
            ...
            if(_enemy.type != "boss"){
                ...
                if (bossFiring === false) {
                    ...
                    c.fillStyle = "#4ad2ff";
                    c.fillRect(0, _enemy.y + 38, _enemy.x + 50, 30);
                    c.fillStyle = "#fffcf9";
                    c.fillRect(0, _enemy.y + 48, _enemy.x + 50, 10);
                }
            }
    ...
    // --------------Desenhando o ataque inimigo e suas interações-----------------
    ...
    // --------------Desenhando o chefe inimigo e suas interações-----------------
